...
[data_I, Fs] = audioread("TESTS_02_10/LIF_CW_2target/low_if_cw_re.wav");
[data_Q, ~] = audioread("TESTS_02_10/LIF_CW_2target/low_if_cw_im.wav");
...
grid on;
% xlim([5 5.05]);
saveas(gcf, 'CW_IQ_plots/Captured_Signal_total.png');
...
xlim([5 5.05]);
grid on;
saveas(gcf, 'CW_IQ_plots/Captured_Signal_zoom.png');
...
% saveas(gcf, 'CW_IQ_plots/Norm1.png');
...
% saveas(gcf, 'CW_IQ_plots/Norm2.png');
...
miss_count_single = 0;
memory_length = 15;   % number of frames to "remember" a target
...
legend;
grid on;
saveas(gcf, 'CW_IQ_plots/Velocity_vs_Time.png');
...
legend;
saveas(gcf, 'CW_IQ_plots/Velocity_vs_Time_curves.png');
...
saveas(gcf, 'CW_IQ_plots/Spec_with_Velocities.png');
