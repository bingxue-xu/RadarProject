...
# Title: CW_radar_SDR_part2
# Author: Group7_2025/2026
# Description: B205mini, fc=5.8 GHz, f_if=4 kHz, fs=250 kS/s, decim=25, fs_out=10 kS/s
...
class CW_radar_SDR_part2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "CW_radar_SDR_part2", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("CW_radar_SDR_part2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "CW_radar_SDR_part2")
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(sample_rate, analog.GR_COS_WAVE, 0, tx_ampl, 0, 0)
        ...
        self.connect((self.blocks_complex_to_float_0, 1), (self.blocks_wavfile_sink_0_0, 0))
        self.connect((self.blocks_complex_to_float_0, 0), (self.qtgui_waterfall_sink_x_0, 0))
        self.connect((self.blocks_complex_to_float_0, 1), (self.qtgui_waterfall_sink_x_0_0, 0))
    ...
    def set_tx_ampl(self, tx_ampl):
        ...
        self.analog_sig_source_x_0.set_amplitude(self.tx_ampl)
    ...
    def set_sample_rate(self, sample_rate):
        ...
        self.qtgui_waterfall_sink_x_0_0.set_frequency_range(0, self.sample_rate)
...
def main(top_block_cls=CW_radar_SDR_part2, options=None):
