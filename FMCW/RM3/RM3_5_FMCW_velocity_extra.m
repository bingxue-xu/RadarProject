%% FMCW Radar
% 
% Extract velocity from range using two-point finite difference 
% method and compare it to range-doppler measurements.
%
% Group 7
% Review Meeting 3
% 23/09/2025
...
%% Read data
[data, Fs] = audioread("../TEST_FILES_19/FMCW_19_t1_3.wav");  % user file
...
xlabel('Time (s)');
ylabel('Velocity (m/s)');
title('Estimated velocity with two-point finite difference');
grid on;
