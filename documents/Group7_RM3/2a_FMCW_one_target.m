%% Range Measurements - FMCW Mode - Single Target
% 
% Group 7
% Review Meeting 3
% 23/09/2025
...
grid on;
saveas(gcf,'FMCW_plots/RM3_time_vs_range_one_target.png');  
...
legend(legend_strings);
saveas(gcf,'FMCW_plots/RM3_time_vs_range__one_target.png');
