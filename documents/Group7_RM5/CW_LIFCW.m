...
%% Read data
[data, Fs] = audioread("TESTS_02_10/LIF_CW_1target/low_if_cw_re.wav");
...
grid on;
% xlim([5 5.05]);
saveas(gcf, 'LOW_IF_CW_1target_plots/Captured_Signal_total.png');
...
xlim([5 5.05]);
grid on;
saveas(gcf, 'LOW_IF_CW_1target_plots/Captured_Signal_zoom.png');
...
saveas(gcf, 'LOW_IF_CW_1target_plots/Norm1.png');
...
saveas(gcf, 'LOW_IF_CW_1target_plots/Norm2.png');
...
legend;
grid on;
saveas(gcf, 'LOW_IF_CW_1target_plots/Velocity_vs_Time.png');



%% Trend Curve

window = 10;  % adjust (number of frames to average)
...
legend;
saveas(gcf, 'LOW_IF_CW_1target_plots/Velocity_vs_Time_curves.png');
...
saveas(gcf, 'LOW_IF_CW_1target_plots/Spec_with_Velocities.png');
