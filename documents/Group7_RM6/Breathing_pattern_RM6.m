...
%% Load Data
[i_data, Fs] = audioread('tests/low_if_cw_re_breathing_last6.wav');
[q_data, ~]  = audioread('tests/low_if_cw_im_breathing_last6.wav');
...
disp('Breath Rate (Breaths per Minute):');
disp(locs * 60);

disp('Heart Rate (Heart beats per Minute) - considering the phenomenon called Respiratory Sinus Arrhythmia (RSA) with an average standard 1:4 ratio:');
disp(locs * 60 * 4);
